...
This helper was written for the Codex Chrome native host, which is absent
under Claude Code; use the `chrome-devtools` skill (Chrome DevTools MCP) or do
the linking manually instead. The helper drives the logged-in
