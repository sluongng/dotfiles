...
description: Design and review landing pages for early-stage B2B devtools, developer infrastructure, AI developer tools, and technical SaaS startups. Use when Claude is asked to create, redesign, critique, or review changes to a startup homepage, launch page, hero section, messaging hierarchy, product-proof section, CTA strategy, visual direction, responsive implementation, or conversion-focused landing page for developers, platform teams, security teams, product engineers, or technical buyers.
---
